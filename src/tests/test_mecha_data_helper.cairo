...
mod tests {
    ...
    fn happy_path() {
        ...
        let turn_player_1 = Turn { 
            id_game, 
            player: player_1, 
            actions: actions_player_1.span() 
        };

        let mecha_state_1_player_1 = MechaState { id: 1, hp: 100, position: Position { x: 2, y: 0 } };
        let mecha_state_2_player_1 = MechaState { id: 2, hp: 100, position: Position { x: 2, y: 1 } };
        let mecha_state_3_player_1 = MechaState { id: 3, hp: 100, position: Position { x: 2, y: 2 } };
        let mecha_state_4_player_1 = MechaState { id: 4, hp: 100, position: Position { x: 2, y: 3 } };
        let mecha_state_5_player_1 = MechaState { id: 5, hp: 100, position: Position { x: 2, y: 4 } };
        ...
        let turn_player_2 = Turn { 
            id_game, 
            player: player_2, 
            actions: actions_player_2.span() 
        };

        let mecha_state_1_player_2 = MechaState { id: 6, hp: 100, position: Position { x: 5, y: 0 } };
        let mecha_state_2_player_2 = MechaState { id: 7, hp: 100, position: Position { x: 5, y: 1 } };
        let mecha_state_3_player_2 = MechaState { id: 8, hp: 100, position: Position { x: 5, y: 2 } };
        let mecha_state_4_player_2 = MechaState { id: 9, hp: 100, position: Position { x: 5, y: 3 } };
        let mecha_state_5_player_2 = MechaState { id: 10, hp: 100, position: Position { x: 5, y: 4 } };
